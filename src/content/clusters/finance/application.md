...
依《大學申請入學招生簡章》（由大學甄選入學委員會發行；招聯會與甄選會是兩個不同單位）第二階段的通則，財經學群校系的審查資料通常包含：
...
審查資料須透過**大學甄選入學委員會**網站（cac.edu.tw）的「審查資料上傳系統」上傳。**務必以申請當年度各校系公告的「審查準備指引」為最終依據**。
...
- [大學甄選入學委員會「申請入學」審查資料上傳（115 學年度）](https://www.cac.edu.tw/apply115/)
